...
const __nuxt_page_meta$2 = {
  layout: false
  // optional, redirect kalau sudah login
};
...
const _routes = [
  ...
  },
  {
    ...
    path: "/profile",
    meta: { "middleware": ["auth"] },
    component: () => import('./profile-Nxo-K9Wo.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": ["auth"] },
    component: () => import('./settings-BEkRBysC.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": ["auth"] },
    component: () => import('./dashboard-oBn8Bqlq.mjs')
  },
  {
...
const namedMiddleware = {
  auth: () => import('./auth-DlzXK80o.mjs'),
  guest: () => import('./guest-BJr_opDT.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DPax-Hey.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-TSS-O0tW.mjs'));
